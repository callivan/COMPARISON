...
export function Select({ className }: ISelectProps) {
  return (
    <div className={[styles["select"], className].join(" ")}>
      <button className={styles["select__btn-active"]} aria-label="Открыть список телефонов для сравнения">
        <svg
      ...
      <div className={styles["select__wrapper"]}>
        ...
        <ul className={styles["select__list"]}>
          <li className={styles["select__item"]}>
            <button className={styles["select__btn-choice"]}>
              <svg
                className={styles["select__replace-icon"]}
                viewBox="0 0 20 20"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <img
                ...
                alt="Телефон"
              />
              <span className={styles["select__phone-name"]}>
                Samsung Galaxy S21
              </span>
            </button>
          </li>
